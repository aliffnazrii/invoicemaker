...
return [
    ...
    */
    ...
    'default_datetime_format' => 'D MMM YYYY, hh:mmA',
    ...
    'project_name' => config('settings.company_name') ??  'Invoice Maker',
    ...
    'project_logo' => config('settings.company_name') ?? '<b>Invoices</b>Maker',
    ...
    'developer_name' => 'AliffTech Solution Sdn Bhd',
